...
class hasil_penjualan_detail_model extends CI_Model {
	...
	function __get_hasil_penjualan_detail($id,$type=1) {
		$sql = "SELECT b.tid as tid,b.ttid as ttid, b.tbid,a.tnofaktur as tnofaktur,a.ttanggal,a.approval,a.tinfo,a.ttotalharga,
		a.ttotaldisc,a.tgrandtotal,a.tinvid,a.tsbayar,		
		b.tqty as tqty,b.tharga as tharga,b.tdisc as tdisc,b.ttotal as ttotal,b.tstatus as tstatus,(select ccode from customer_tab d where d.cid=a.tcid)as ccode,(select cname from customer_tab d where d.cid=a.tcid)as cname,(select caddr from customer_tab d where d.cid=a.tcid)as caddr,(select bcode from books_tab c where c.bid=b.tbid)as bcode,(select btitle from books_tab c where c.bid=b.tbid)as btitle FROM transaction_tab a, transaction_detail_tab b WHERE (a.tstatus='1' OR a.tstatus='0') AND ttype='1' AND ttypetrans='1'  AND a.tid=b.ttid AND a.tid='$id' ORDER BY b.tid ASC";
