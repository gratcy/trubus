...
class Inventory_model extends CI_Model {
	...
	//a.ibid=b.bid --->BUKU
		return 'SELECT a.iid,ibid,a.ibcid,a.istockbegining,a.istockin,a.istockout,a.istockretur,a.istockreject,a.istock,a.istatus,b.btitle,c.bname FROM inventory_tab a LEFT JOIN books_tab b ON a.ibid=b.bid LEFT JOIN branch_tab c ON a.ibcid=c.bid WHERE a.itype=1 AND (a.istatus=1 OR a.istatus=0) ORDER BY a.iid DESC';
	}
...
function __get_book($id){
	...
	function __get_inventory_detailx($id,$cid) {
		//echo "* FROM transaction_tab a, transaction_detail_tab b WHERE a.tbid='$cid' AND a.tid=b.ttid and b.tbid= $id";die;
