...
class Inventory_model extends CI_Model {
	...
	function __get_inventory() {
		return 'SELECT a.iid,ibid,a.istockbegining,a.istockin,a.istockout,a.istockreject,a.istock,a.istatus,b.btitle,c.bname FROM inventory_tab a LEFT JOIN books_tab b ON a.ibid=b.bid LEFT JOIN branch_tab c ON a.ibcid=c.bid WHERE a.itype=1 AND (a.istatus=1 OR a.istatus=0) ORDER BY a.iid DESC';
	}
