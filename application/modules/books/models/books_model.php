...
class Books_model extends CI_Model {
	...
	function __get_books_search_inventory($keyword) {
		...
		$this -> db -> select("a.bid FROM books_tab a LEFT JOIN publisher_tab b ON a.bpublisher=b.pid WHERE (a.btitle LIKE '%".$keyword."%' OR a.bcode LIKE '%".$keyword."%' OR b.pname LIKE '%".$keyword."%')");
		return $this -> db -> get() -> result();
	}
