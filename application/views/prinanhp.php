...
$sql="SELECT *,
        ...
        (select bcode from books_tab c where c.bid=b.tbid)as bcode,
		(select btitle from books_tab c where c.bid=b.tbid)as btitle
		FROM transaction_tab a, transaction_detail_tab b WHERE (a.tstatus='1' OR a.tstatus='0') AND ttype='1' AND ttypetrans='1'  AND a.tid=b.ttid AND a.tid='$id' ORDER BY b.tid  limit $cx,$jum_baris";
...
<td width="98" rowspan="5" valign="top" class="axx"><img src="<?php echo site_url('application/views/assets/img/hex00.jpg');?>" alt="okt" width="71" height="65"  /><span class="ax"><font color=white ></font></span></td>
    ...
    <td colspan=4 width="91" valign="top" class="axx"><div align="left"><span class="axx"></span><b>Faktur Hasil Penjualan</b></div></td>
...
<?php }?>
  ...
  <tr>
    ...
    <tr>
    <td colspan="2" valign="top">&nbsp;</td>
    <td colspan="3" valign="top"><span class="ax">Hasil Penjualan</span></td>
