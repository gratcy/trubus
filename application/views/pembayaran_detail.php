...
<!-- form start -->
	...
	<br>
<h3 class="box-title">
               &nbsp;&nbsp; <a href="<?php echo site_url('pembayaran_detail/pembayaran_detail_add/'. $id); ?>" class="btn btn-default"><i class="fa fa-plus"></i> Add Pembayaran detail</a></h3>
	...
	<?php if ($v -> tstatus <> 1) { ?>
              ...
              <a href="<?php echo site_url('pembayaran_detail/pembayaran_detail_delete/' . $v -> tid); ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-times"></i></a>
		<?php } ?>
		</td>
										</tr>
        <?php endforeach; ?>
