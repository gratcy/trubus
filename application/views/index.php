                        ...
                        <section class="col-lg-6 connectedSortable">
                            ...
                            <div class="box box-success">
                                ...
                                <div class="box-body chat" id="chat-box">
                                    <!-- chat item -->
                                    <div class="item">
                                        <img src="<?php echo site_url('application/views/assets/img/avatar.png'); ?>" alt="user image" class="online"/>
                                        <p class="message">
                                            <a href="#" class="name">
                                    ...
                                    <!-- chat item -->
                                    <div class="item">
                                        <img src="<?php echo site_url('application/views/assets/img/avatar2.png'); ?>" alt="user image" class="offline"/>
                                        <p class="message">
                                            <a href="#" class="name">
                                    ...
                                    <!-- chat item -->
                                    <div class="item">
                                        <img src="<?php echo site_url('application/views/assets/img/avatar3.png'); ?>" alt="user image" class="offline"/>
                                        <p class="message">
                                            <a href="#" class="name">
