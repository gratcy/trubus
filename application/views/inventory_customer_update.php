...
<div class="box box-primary">
                                <!-- form start -->
                                 <form role="form" action="<?php echo site_url('inventory_customer/inventory_customer_update'); ?>" method="post">
