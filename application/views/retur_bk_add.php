		...
		$("#thebcode").val(ui.item.bcode)
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1>
                        Retur Pembelian Konsinyasi Add
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="<?php echo site_url(); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="<?php echo site_url('retur_bk'); ?>">retur_bk</a></li>
                        <li class="active">retur_bk Add</li>
                    </ol>
                </section>
...
<div class="box box-primary">
                                <!-- form start -->
                                 <form role="form" action="<?php echo site_url('retur_bk/retur_bk_add'); ?>" method="post" id="form1">
 ...
 <div data-bind="nextFieldOnEnter:true">
                        ...
                        <input type="text" placeholder="No Faktur" name="tnofaktur" class="form-control" value="RBK" />
                                        </div>
...
<?php foreach ($gudang_penerbit as $k=>$v){
