            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo site_url('inventory_shadow'); ?>">Stock Book</a></li>
                        <li class="active">Stock Shadow Add</li>
                    </ol>
                </section>
...
<div class="box box-primary">
                                <!-- form start -->
                                 <form role="form" action="<?php echo site_url('inventory_shadow/inventory_shadow_add'); ?>" method="post">
                                    <div class="box-body">
