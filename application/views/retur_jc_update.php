...
<div class="box box-primary">
                                <!-- form start -->
                                 <form role="form" action="<?php echo site_url('retur_jc/retur_jc_update'); ?>" method="post">
<input type="hidden" name="id" value="<?php echo $id; ?>">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label>Name</label>
                        <input type="text" placeholder="retur_jc Name" name="name" class="form-control" value="<?php echo $detail[0] -> bname; ?>" />
                                        </div>
                                        <div class="form-group">
                                            <label>NPWP</label>
                        <input type="text" placeholder="retur_jc NPWP" name="npwp" class="form-control" value="<?php echo $detail[0] -> bnpwp; ?>" />
                                        </div>
                                        <div class="form-group">
                                            <label>Address</label>
