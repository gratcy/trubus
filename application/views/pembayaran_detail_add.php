	...
	<?php echo __get_error_msg(); ?>
							<div class="box">
                                ...
                                <div class="box-body">
                                    ...
                                    <tbody>
         <form role="form" id="form1" action="<?php echo site_url('pembayaran_detail/pembayaran_detail_add/'.$id); ?>" method="post">
...
<input  type=hidden name="id" class="form-control"  value="<?php echo $id;?>" >
			...
			<form role="form" id="form1" action="<?php echo site_url('pembayaran_detail/pembayaran_update/'.$id); ?>" method="POST" >											
	<br>
	<hr></hr>
	  <div class="box-body">
		  ...
		  //print_r($view);die;
		  // echo "<pre>";
		  // print_r($pembayaran_detail);
		  // echo "</pre>";
		  $i=1;
		  $tthargaz=0;
		  $ff=0;
		  $jumbk= count($pembayaran_detail);
	...
	<?php if ($v -> tstatus <> 2) { ?>
<!--
              <a href="<?php echo site_url('pembayaran_detail/pembayaran_detail_update/' . $v -> tid); ?>"><i class="fa fa-pencil"></i></a>
-->
              <a href="<?php echo site_url('pembayaran_detail/pembayaran_detail_delete/' . $v -> tid.'/'.$id); ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-times"></i></a>
		<?php } ?>
		</td>
										</tr>
		  <?php } ?>
 ...
 <tr>
	...
	<!--form role="form" id="form1" action="<?php //echo site_url('pembayaran_detail/pembayaran_update'); ?>" method="POST" -->
...
<input  type=hidden name="tid" class="form-control"  value="<?php echo $id;?>" >
								...
								<textarea  name="tinfo" class="form-control" ><?php echo $detail[0] -> tinfo; ?></textarea>
                                    ...
                                    <div class="box-footer">
                                        <input type="submit" onkeydown="nginput();" class="btn btn-primary" value="Submit" > 
										<button class="btn btn-default" type="button" onclick="location.href='<?php echo site_url('pembayaran');?>'">CLOSE</button>
                                    </div>
                                </form>
