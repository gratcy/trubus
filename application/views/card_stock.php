...
<input type="hidden" name="id" value="<?php echo $id; ?>">
									...
									<tr><td>Buku</td><td>: <?php echo $books; ?></td></tr>
						...
						?>
						<tr style="border:1px solid #000;"><td style="border:1px solid #000;"></td><td style="border:1px solid #000;"><?php echo $k->cname; ?></td><td style="border:1px solid #000;"></td> <td style="border:1px solid #000;"> <?php echo $k -> istockin; ?></td><td style="border:1px solid #000;"></td><td style="border:1px solid #000;"></td></tr>
