            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo site_url('customer_group'); ?>">customer Group</a></li>
                        <li class="active">customer Group Update</li>
                    </ol>
                </section>
...
<div class="box box-primary">
                                <!-- form start -->
                                 <form role="form" action="<?php echo site_url('customer_group/customer_group_update'); ?>" method="post">
