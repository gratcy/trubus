            ...
            <aside class="right-side">                
                ...
                <section class="content">
                    ...
                    <div class="row">
						<form action="<?php echo site_url('penjualan_kredit/penjualan_kredit_search/'); ?>" method="post">
                <div class="form-group">
	...
	<?php echo __get_error_msg(); ?>
							...
							<div class="box">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">
                <a href="<?php echo site_url('penjualan_kredit/penjualan_kredit_addx'); ?>" class="btn btn-default"><i class="fa fa-plus"></i> Add Penjualan Kredit</a></h3>
                                </div><!-- /.box-header -->
