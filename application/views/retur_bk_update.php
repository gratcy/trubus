            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo site_url('retur_bk'); ?>">Retur Penjualan Kredit</a></li>
...
<div class="box box-primary">
                                <!-- form start -->
                                 <form role="form" action="<?php echo site_url('retur_bk/retur_bk_update'); ?>" method="post">
<input type="hidden" name="id" value="<?php echo $id; ?>">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label>Name</label>
                        <input type="text" placeholder="retur_bk Name" name="name" class="form-control" value="<?php echo $detail[0] -> bname; ?>" />
                                        </div>
                                        <div class="form-group">
                                            <label>NPWP</label>
                        <input type="text" placeholder="retur_bk NPWP" name="npwp" class="form-control" value="<?php echo $detail[0] -> bnpwp; ?>" />
                                        </div>
                                        <div class="form-group">
                                            <label>Address</label>
