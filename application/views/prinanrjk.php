...
$sqlx="SELECT *,
		...
		FROM transaction_tab a, transaction_detail_tab b WHERE (a.tstatus='1' OR a.tstatus='0') AND ttype='1' AND ttypetrans='4'  AND a.tid=b.ttid AND a.tid='$id' ORDER BY b.tid DESC";
...
$sql="SELECT *,
        ...
        (select bcode from books_tab c where c.bid=b.tbid)as bcode,
		(select btitle from books_tab c where c.bid=b.tbid)as btitle
		FROM transaction_tab a, transaction_detail_tab b WHERE (a.tstatus='1' OR a.tstatus='0') AND ttype='1' AND ttypetrans='4'  AND a.tid=b.ttid AND a.tid='$id' ORDER BY b.tid  limit $cx,$jum_baris";
...
<td width=220 valign="top"></td>
    ...
    <td  colspan=3  width=120 valign="top" class="axx"><div align="left"><span class="axx"></span><b>Retur Penjualan Konsinyasi</b><br>&nbsp;</div></td>
...
<?php }?>
  ...
  <tr>
    <td colspan="4" valign="top">&nbsp;</td>
    <td colspan="2" valign="top"><span class="ax">Retur Penjualan Konsinyasi</span></td>
