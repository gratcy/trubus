...
<!-- form start -->
	...
	<br>
<h3 class="box-title">
               &nbsp;&nbsp; <a href="<?php echo site_url('retur_jk_detail/retur_jk_detail_add/'. $id); ?>" class="btn btn-default"><i class="fa fa-plus"></i> Add hasil penjualan detail</a></h3>
