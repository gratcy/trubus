            ...
            <aside class="right-side">                
                ...
                <section class="content">
	                    ...
	                    <div class="row">
						<form action="<?php echo site_url('retur_jk/hasil_retur_excel/'); ?>" method="post">
	...
	<?php echo __get_error_msg(); ?>
		  ...
		  <td>
	<?php if ($v -> tstatus <> 2) { ?>
	              <a href="javascript:void(0);" onclick="print_data('<?php echo site_url('retur_jk_detail/retur_jk_faktur/' . $v -> tid); ?>', 'Print Penawaran');"><i class="fa fa-print"></i></a>
              <a href="<?php echo site_url('retur_jk_details/' . $v -> tid); ?>"><i class="fa fa-pencil"></i></a>
              <a href="<?php echo site_url('retur_jk/retur_jk_delete/' . $v -> tid); ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-times"></i></a>
		<?php } ?>
		</td>
										</tr>
        <?php endforeach; ?>
