...
<!-- form start -->
                                 <form role="form" action="<?php echo site_url('pembayaran_detail/pembayaran_detail_add'); ?>" method="post">
                                    <div class="box-body">
	...
	<br>
	  ...
	  <div class="box-body">
		  ...
		  <?php
		  $i=1;
		  $jcount=count($pembayaran_detail);
		  if($jcount>0){
       ...
       <?php if($app < 2){?>
		<br />
		 <a href="<?php echo site_url('pembayaran_detail/pembayaran_detail_add/'. $id); ?>" class="btn btn-default"><i class="fa fa-plus"></i> Edit Penjualan</a>							
	   							
		<a href="<?php echo site_url('pembayaran_detail/pembayaran_detail_approval'.$appx.'/'. $id); ?>" class="btn btn-default"><i class="fa fa-plus"></i> APPROVAL <?=$appx;?></a>							
		<?php } else{?>	
         <a href="javascript:void(0);" onclick="print_data('<?php echo site_url('pembayaran_detail/pembayaran_faktur/' . $id); ?>', 'Print Penawaran');"><i class="fa fa-print"></i></a>
		  <?php } }else{ ?>	
 <a href="<?php echo site_url('pembayaran_detail/pembayaran_detail_add/'. $id); ?>" class="btn btn-default"><i class="fa fa-plus"></i> Edit Penjualan</a>
		  <?php } ?>		  
