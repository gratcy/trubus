...
<input type="hidden" name="id" value="<?php echo $id; ?>">
                        ...
                        <input type="text" placeholder="Customer/Area" name="custarea" class="form-control" value="<?php echo $detail[0] -> custarea;?>" autocomplete="off" />                        <span id="sg1"></span>
                        <input type="hidden" name="caid" value="<?php echo $detail[0] -> ppca; ?>" />
                                        </div>
                                        <div class="form-group">
                                            <label>Books</label>
