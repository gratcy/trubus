            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Retur Penjualan Kredit</li>
                    </ol>
                </section>
                ...
                <section class="content">
	                    ...
	                    <div class="row">
						<form action="<?php echo site_url('retur_jc/hasil_retur_excel/'); ?>" method="post">
                    ...
                    <div class="row">
						<form action="<?php echo site_url('retur_jc/retur_jc_search/'); ?>" method="post">
                <div class="form-group">
	...
	<?php echo __get_error_msg(); ?>
							...
							<div class="box">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">
                <a href="<?php echo site_url('retur_jc/retur_jc_add'); ?>" class="btn btn-default"><i class="fa fa-plus"></i> Add Retur Penjualan Kredit</a></h3>
                                </div><!-- /.box-header -->
		  ...
		  <td>
	<?php if ($v -> tstatus <> 2) { ?>
	              <a href="javascript:void(0);" onclick="print_data('<?php echo site_url('retur_jc_detail/retur_jc_faktur/' . $v -> tid); ?>', 'Print Penawaran');"><i class="fa fa-print"></i></a>
				    <?php if ($appr<2){?> 
              <a href="<?php echo site_url('retur_jc_details/' . $v -> tid); ?>"><i class="fa fa-pencil"></i></a>
              <a href="<?php echo site_url('retur_jc/retur_jc_delete/' . $v -> tid); ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-times"></i></a>
	<?php } } ?>
		</td>
										</tr>
        <?php endforeach; ?>
